...
const Coins = () => {
    ...
    return (
        <>
            {spinner ? <Spinner /> : <div className='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
                <p className='text-center text-3xl font-bold text-gray'>Available Crypto Currencies</p>
                <p className='text-center mb-12 tex-xl font-normal text-gray-500'>Total Coins:{coins.length}</p>
